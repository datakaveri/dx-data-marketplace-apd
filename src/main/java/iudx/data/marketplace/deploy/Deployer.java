 ...
 * ,iudx.data.marketplace.apiserver.ApiServerVerticle</i>
 */
public class Deployer {
  ...
  public static void main(String[] args) {
    ...
    CLI cli = CLI.create("DX DMP-APD Server").setSummary("A CLI to deploy the DMP-APD server")
        .addOption(new Option().setLongName("help").setShortName("h").setFlag(true).setDescription("display help"))
        .addOption(
            new Option().setLongName("config").setShortName("c").setRequired(true).setDescription("configuration file"))
        .addOption(new Option().setLongName("isClustered").setShortName("C").setRequired(true).setDefaultValue("false")
            .setDescription("Is it being deployed in clustered mode"))

        .addOption(new Option().setLongName("host").setShortName("i").setRequired(true).setDefaultValue("localhost")
    ...
    boolean isDeploymentInClusteredMode = Boolean.parseBoolean(commandLine.getOptionValue("isClustered"));
  ...
  public static void deployInClusteredMode(String configPath, String host, List<String> modules) {
    ...
    VertxOptions options =
        new VertxOptions().setClusterManager(mgr).setEventBusOptions(ebOptions).setMetricsOptions(getMetricsOptions());
  ...
  public static ClusterManager getClusterManager(String host, List<String> zookeepers, String clusterId) {
    ...
    discoveryStrategyConfig.addProperty(ZookeeperDiscoveryProperties.ZOOKEEPER_URL.key(), String.join(",", zookeepers));
  ...
  public static MetricsOptions getMetricsOptions() {
    return new MicrometerMetricsOptions().setPrometheusOptions(
        ...
        .setLabels(EnumSet.of(Label.EB_ADDRESS, Label.EB_FAILURE, Label.HTTP_CODE, Label.HTTP_METHOD)).setEnabled(true);
  }
