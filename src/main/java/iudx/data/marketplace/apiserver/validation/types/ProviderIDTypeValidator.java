...
import static iudx.data.marketplace.apiserver.util.Constants.VALIDATION_PROVIDER_ID_MAXLEN;
import static iudx.data.marketplace.apiserver.util.Constants.VALIDATION_PROVIDER_ID_REGEX;
...
public class ProviderIDTypeValidator implements Validator {
  ...
  public boolean isValidID(final String value) {
    return VALIDATION_PROVIDER_ID_REGEX.matcher(value).matches();
  }
  ...
  public boolean isValid() {
    ...
    if (value.length() > VALIDATION_PROVIDER_ID_MAXLEN) {
