...
public class VerifyTokenTypeValidator implements Validator {

  public static final Logger LOGGER = LogManager.getLogger(VerifyTokenTypeValidator.class);

  private final String value;
  private final boolean required;

  public VerifyTokenTypeValidator(final String value, final boolean required) {
    this.value = value;
  ...
  private boolean isValidId(String value) {
    return BEARER_TOKEN_PATTERN_FOR_VERIFY.matcher(value).matches();
  }
