...
public interface LinkedAccountService {
     ...
     * @return Future of JsonObject when it is successful, Future containing failure message during failure
     */
     ...
     * @param user Provider details as User object
     * @return Future of JsonObject containing linked account details sent by Razorpay
     * when it is successful, Future containing failure message during failure
     */
     ...
     * @param request Provider's business related information to create a linked account
     *                all the details expect <b>business_type</b>, <b>email</b> can be updated
     * @param user Provider details as User object
     * @return Future of JsonObject when it is successful, Future containing failure message during failure
     */
