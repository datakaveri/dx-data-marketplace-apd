package iudx.data.marketplace.apiserver.provider.linkedaccount.service;
...
public class UpdateLinkedAccount {
  private static final Logger LOGGER = LogManager.getLogger(UpdateLinkedAccount.class);
