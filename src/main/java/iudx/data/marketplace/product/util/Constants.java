...
public class Constants {
  ...
  public static final String SELECT_PRODUCT_QUERY =
      "select count(*) from $0 where providerID='$1' and product_id='$2'";

  public static final String INSERT_PRODUCT_QUERY =
      "insert into $0 (product_id, providerID, providerName, status) values ('$1', '$2', '$3', '$4')";
  public static final String INSERT_RESOURCE_QUERY =
      "insert into $0 (_id, resource_name, provider_id, providerName, resource_server, accessPolicy) values ('$1', '$2', '$3', '$4', '$5', '$6') on conflict (_id) do nothing";
