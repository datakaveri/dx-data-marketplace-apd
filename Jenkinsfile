pipeline {
  ...
  stages {
    ...
    stage('Unit Tests and Code Coverage Test'){
      steps{
        script{
          sh 'cp /home/ubuntu/configs/5.6.0/dmp-apd-server-config-test.json ./secrets/all-verticles-configs/config-test.json'
