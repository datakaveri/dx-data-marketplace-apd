  ...
  stages {
    ...
    stage('Unit Tests and Code Coverage Test'){
      ...
      always {
        ...
        jacoco classPattern: 'target/classes', execPattern: 'target/jacoco.exec', sourcePattern: 'src/main/java', exclusionPattern:'iudx/data/marketplace/apiserver/ApiServerVerticle.class,**/*VertxEBProxy.class,**/Constants.class,**/*VertxProxyHandler.class,**/*Verticle.class,**/JwtDataConverter.class,iudx/data/marketplace/apiserver/ProviderApis.class,iudx/data/marketplace/apiserver/ConsumerApis.class,iudx/data/marketplace/deploy/*.class,**/*Service.class'
    ...
    stage('Push Images') {
  	when {
          ...
          expression {
        	return env.GIT_BRANCH == 'origin/1.0.0';
          }
    	  }
  	}
  	steps {
          ...
          docker.withRegistry( registryUri, registryCredential ) {
        	...
        	deplImage.push("1.0.0-${env.GIT_HASH}")
          }
    	  }
  	}
    }
    ...
    post{
        failure{
        script{
            if (env.GIT_BRANCH == 'origin/1.0.0')
